...
// - Message-ID: <send_123@your-domain.com>
```
...
<p>
  <a href="{{campaign.landing_page}}">View Your Personalized Page</a>
</p>
...
<!-- Renders as: -->
<a href="https://your-domain.com/promo/your-page?utm_source=email&contact_id=123">
  View Your Personalized Page
</a>

<a href="https://your-domain.com/unsubscribe?email=prospect@example.com&campaign_id=456">
  Unsubscribe
</a>
```
