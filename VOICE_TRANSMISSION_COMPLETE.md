...
| **Frame Rate** | ✅ Calculated | Every 30 seconds | <5 fps = warning |
| **Connection Status** | ✅ Real-time | Every 30 seconds | Disconnected = alert |
| **Last Audio Time** | ✅ Timestamp | Every 30 seconds | >15 seconds = alert |
...
|--------|--------|-----------|
| Time to First Audio | <2s | <5s |
| Frame Rate | 20-30 fps | 10-40 fps |
| Latency | <200ms | <500ms |
