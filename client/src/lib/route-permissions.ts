...
export const ROUTE_PERMISSIONS: RoutePermission[] = [
  ...
  { pattern: '/campaign-analytics', roles: MANAGEMENT_ROLES, description: 'Campaign Analytics' },
  ...
  { pattern: '/call-recordings', roles: ANALYTICS_ROLES, description: 'Call Recordings' },
