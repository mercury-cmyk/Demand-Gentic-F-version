  ...
  // ============================================
  {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          {
            id: 'verification-campaigns',
            title: 'Campaigns',
            url: '/verification/campaigns',
            roles: [...DATA_ROLES, USER_ROLES.QUALITY_ANALYST],
            description: 'Verification campaign management',
          },
          {
            id: 'verification-console',
            title: 'Console',
            url: '/verification-console',
            roles: [...DATA_ROLES, USER_ROLES.QUALITY_ANALYST],
            description: 'Verification operations console',
          },
          {
            ...
            roles: [...DATA_ROLES, USER_ROLES.QUALITY_ANALYST],
            description: 'Upload verification data and suppression lists',
          },
        ],
      },
    ],
