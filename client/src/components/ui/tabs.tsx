...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-lg border border-border/60 bg-card/60 p-1.5 text-muted-foreground shadow-xs backdrop-blur",
      className
    )}
    {...props}
  />
