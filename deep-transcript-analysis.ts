...
async function deepTranscriptAnalysis(): Promise<void> {
  ...
  const misclassifiedCalls: Array<TranscriptCall & { analysis: ReturnType<typeof analyzeTranscript> }> = [];
  const longCallsReview: Array<TranscriptCall & { analysis: ReturnType<typeof analyzeTranscript> }> = [];
...
function printDetailedCall(call: TranscriptCall & { analysis?: ReturnType<typeof analyzeTranscript> }): void {
