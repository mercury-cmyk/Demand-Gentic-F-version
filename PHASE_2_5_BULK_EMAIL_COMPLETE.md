...
#### `queueBulkEmails(options: BulkEmailOptions): Promise<BulkEmailResult>`
...
#### `sendCampaignEmails(campaignId: string): Promise<BulkEmailResult>`
...
#### `sendTestEmail(options: TestEmailOptions): Promise<{ success: boolean; sent: number }>`
