...
[AiMediaStreaming] ✅ FIRST OUTBOUND AUDIO FRAME SENT to Telnyx! call=<call_id> stream_id=<stream_id>
[Voice-Dialer] ✅ FIRST OUTBOUND AUDIO FRAME SENT to Telnyx! call=<call_id> stream_id=<stream_id>
...
TELNYX_CALL_CONTROL_APP_ID=<your-app-id>
