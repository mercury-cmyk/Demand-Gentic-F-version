...
| Issue | Solution |
|-------|----------|
| Still getting `invalid_client` after redeploy | 1. Clear browser cache<br>2. Wait 5-10 mins for Cloud Run to fully redeploy<br>3. Check that redirect URIs are registered in Google Cloud Console |
