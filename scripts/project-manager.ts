 ...
 *   npm run project -- switch <project-id>     # Switch to a project
 *   npm run project -- current                 # Show current project
 *   npm run project -- add <project-id>        # Add a new project (will prompt for details)
 *   npm run project -- remove <project-id>     # Remove a project
 *   npm run project -- show <project-id>       # Show project configuration
 */
...
function listProjects() {
  ...
  if (Object.keys(config.projects).length === 0) {
    ...
    console.log('   Use: npm run project -- add <project-id>');
    return;
  }
...
function prompt(rl: any, question: string): Promise<string> {
...
Usage:
  npm run project -- list              List all configured projects
  npm run project -- current           Show current project
  npm run project -- add <id>          Add a new project
  npm run project -- switch <id>       Switch to a project
  npm run project -- show <id>         Show project details
  npm run project -- remove <id>       Remove a project
