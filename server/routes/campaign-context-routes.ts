...
router.post('/validate', async (req: Request, res: Response) => {
  try {
    const { context }: { context: Partial<StructuredCampaignContext> } = req.body;
...
router.post('/finalize', async (req: Request, res: Response) => {
  try {
    ...
    let finalContext: Partial<StructuredCampaignContext>;
 ...
 */
function convertToLegacyFormat(context: Partial<StructuredCampaignContext>): Record<string, any> {
