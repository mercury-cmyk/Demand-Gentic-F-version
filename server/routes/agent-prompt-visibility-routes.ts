        ...
        voice: [
          {
            ...
            description: 'Real-time voice conversations with OpenAI',
            capabilities: ['voice_call', 'realtime', 'turn_detection'],
          },
          {
            id: 'gemini',
            name: 'Google Gemini Live',
            model: 'gemini-2.0-flash-live-001',
            description: 'Real-time voice conversations with Gemini',
            capabilities: ['voice_call', 'realtime', 'multimodal'],
          },
        ],
      },
    });
