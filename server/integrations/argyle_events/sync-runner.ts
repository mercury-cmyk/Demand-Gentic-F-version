 ...
 */
export async function resolveArgyleClientId(): Promise<string | null> {
 ...
 */
export async function isArgyleClient(clientAccountId: string): Promise<boolean> {
...
async function upsertDraft(
  ...
  const mergedDraftFields = mergeFields(
    sourceFields,
    existingDraft.draftFields as Record<string, any>,
 ...
 */
export async function runArgyleEventSync(useLLM: boolean = false): Promise<SyncRunResult> {
