-- Migration: Client Campaign Pricing
-- Description: Adds per-client, per-campaign-type pricing configuration
-- This allows setting different prices for the same service for different clients

-- Create client_campaign_pricing table
