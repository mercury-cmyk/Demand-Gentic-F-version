...
function inferLegacyProviderKey(profile?: Pick<SenderProfile, 'espProvider' | 'espAdapter'> | null): string | null {
...
function decryptOptional(payload?: string | null): string | undefined {
  ...
  return decryptJson<string>(payload, requireProviderSecret());
}
...
async function ensureCampaignEmailSchema(): Promise<void> {
...
function applyTemplate(input: string | undefined | null, values: Record<string, string>): string | undefined {
...
async function sendViaMailgun(provider: ResolvedCampaignEmailProvider, params: SendCampaignEmailParams['options']): Promise<{ messageId: string; providerKey: string }> {
...
async function sendViaBrevo(provider: ResolvedCampaignEmailProvider, params: SendCampaignEmailParams['options']): Promise<{ messageId: string; providerKey: string }> {
  if (!provider.apiKey) {
...
async function sendViaSmtp(provider: ResolvedCampaignEmailProvider, params: SendCampaignEmailParams['options']): Promise<{ messageId: string; providerKey: string }> {
...
async function sendViaProvider(provider: ResolvedCampaignEmailProvider, params: SendCampaignEmailParams['options']): Promise<{ messageId: string; providerKey: string }> {
...
export async function listCampaignEmailProviders(): Promise<SanitizedCampaignEmailProvider[]> {
...
async function resolveDefaultProvider(): Promise<ResolvedCampaignEmailProvider | null> {
  await ensureCampaignEmailSchema();
...
async function resolveProviderByKey(providerKey: string): Promise<ResolvedCampaignEmailProvider | null> {
  await ensureCampaignEmailSchema();
...
async function resolveProviderForSend(providerId?: string | null, providerKey?: string | null): Promise<ResolvedCampaignEmailProvider> {
...
export async function createCampaignEmailProvider(input: {
  ...
  sendingProfile?: CampaignEmailSendingProfile;
  createdBy?: string | null;
}): Promise<SanitizedCampaignEmailProvider> {
  await ensureCampaignEmailSchema();
...
export async function updateCampaignEmailProvider(providerId: string, input: {
...
}): Promise<SanitizedCampaignEmailProvider | null> {
  await ensureCampaignEmailSchema();
  ...
  const [updated] = await db
    .update(campaignEmailProviders)
    .set(updatePayload as Partial<typeof campaignEmailProviders.$inferInsert>)
    .where(eq(campaignEmailProviders.id, providerId))
    .returning();
...
export async function deleteCampaignEmailProvider(providerId: string): Promise<boolean> {
  await ensureCampaignEmailSchema();
...
async function updateProviderHealth(providerId: string, result: ProviderVerificationResult): Promise<void> {
...
export async function verifyCampaignEmailProvider(providerId: string): Promise<ProviderVerificationResult> {
...
export async function sendCampaignEmail(params: SendCampaignEmailParams): Promise<{ messageId: string; providerId: string; providerKey: string; providerName: string }> {
...
export async function getCampaignEmailProviderBindingForSender(senderProfileId: string): Promise<SanitizedCampaignEmailProvider | null> {
  await ensureCampaignEmailSchema();
...
export async function getCampaignEmailProviderBindingForDomain(domainAuthId: number): Promise<SanitizedCampaignEmailProvider | null> {
  await ensureCampaignEmailSchema();
...
export async function resolveCampaignEmailProviderForSenderProfile(profile: SenderProfile | null | undefined): Promise<SanitizedCampaignEmailProvider | null> {
...
export async function getCampaignEmailManagementOverview(): Promise<{
  providers: SanitizedCampaignEmailProvider[];
