...
Pivotal B2B - DemandGentic.ai Platform`,
    variables: [
      ...
      { name: 'inviteLink', description: 'Password reset URL with token (legacy variable name)', required: true, exampleValue: 'https://app.demandgentic.ai/reset-password?token=abc123&type=client' },
      { name: 'resetLink', description: 'Password reset URL with token', required: false, exampleValue: 'https://app.demandgentic.ai/reset-password?token=abc123&type=client' },
...
Your campaign is now being set up. We'll notify you when leads start coming in.`,
    variables: [
      ...
      { name: 'portalLink', description: 'Link to view project in portal', required: false, exampleValue: 'https://app.demandgentic.ai/projects/123' },
    ],
  },
  {
...
Track progress: {{portalLink}}`,
    variables: [
      ...
      { name: 'portalLink', description: 'Link to campaign in portal', required: false, exampleValue: 'https://app.demandgentic.ai' },
    ],
  },
  {
...
View leads: {{portalLink}}`,
    variables: [
      ...
      { name: 'portalLink', description: 'Link to view leads', required: false, exampleValue: 'https://app.demandgentic.ai/leads' },
    ],
  },
  {
...
Pivotal B2B - DemandGentic.ai Platform`,
    variables: [
      ...
      { name: 'approvedBy', description: 'Admin who approved', required: false, exampleValue: 'Admin User' },
      { name: 'portalLink', description: 'Link to view campaign in client portal', required: false, exampleValue: 'https://app.demandgentic.ai/campaigns/abc123' },
    ],
  },
  {
...
Pivotal B2B - DemandGentic.ai Platform`,
    variables: [
      ...
      { name: 'portalLink', description: 'Link to view order in client portal', required: false, exampleValue: 'https://app.demandgentic.ai/orders/abc123' },
    ],
  },
  {
    templateKey: 'project_request_approved',
...
Pivotal B2B - DemandGentic.ai Platform`,
    variables: [
      ...
      { name: 'approvalDate', description: 'Date of approval', required: true, exampleValue: 'February 21, 2026' },
      { name: 'approvedBy', description: 'Admin who approved', required: false, exampleValue: 'Admin User' },
      { name: 'portalLink', description: 'Link to view project in client portal', required: false, exampleValue: 'https://app.demandgentic.ai/projects' },
    ],
  },
  {
    templateKey: 'project_request_rejected',
