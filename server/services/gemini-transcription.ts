 ...
 */
export async function transcribeWithGemini(audioUrl: string): Promise<TranscriptionResult> {
  if (!GEMINI_API_KEY) {
 ...
 */
export async function transcribeLeadWithGemini(leadId: string): Promise<boolean> {
