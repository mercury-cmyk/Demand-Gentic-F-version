 ...
 */
export async function getServiceCatalog(organizationId?: string): Promise<ServiceDefinition[]> {
  let query = db
    .select()
 ...
 * Get a service by ID
 */
export async function getServiceById(id: number): Promise<ServiceDefinition | null> {
...
export async function createService(
  service: Omit<InsertOrganizationServiceCatalogEntry, "createdAt" | "updatedAt">,
  userId?: string
...
export async function updateService(
  id: number,
  updates: Partial<Omit<InsertOrganizationServiceCatalogEntry, "createdAt" | "updatedAt">>
...
export async function getCampaignServiceOverrides(
  campaignId: string
): Promise<CampaignServiceCustomizationFull[]> {
...
export async function setCampaignServiceOverride(
  campaignId: string,
  serviceId: number,
  overrides: Partial<Omit<InsertCampaignServiceCustomization, "campaignId" | "serviceId" | "createdAt" | "updatedAt">>
): Promise<CampaignServiceCustomizationFull> {
 ...
 */
export async function getServicesForIndustry(industry: string): Promise<ServiceDefinition[]> {
 ...
 */
export async function getServicesForPersona(persona: string): Promise<ServiceDefinition[]> {
  const catalog = await getServiceCatalog();
