 ...
 */
export async function getProblemDefinitions(organizationId?: string): Promise<ProblemDefinitionFull[]> {
  let query = db
    .select()
 ...
 */
export async function getProblemDefinitionById(id: number): Promise<ProblemDefinitionFull | null> {
...
export async function createProblemDefinition(
  definition: Omit<InsertProblemDefinition, "createdAt" | "updatedAt">,
  userId?: string
): Promise<ProblemDefinitionFull> {
...
export async function updateProblemDefinition(
  id: number,
  updates: Partial<Omit<InsertProblemDefinition, "createdAt" | "updatedAt">>
): Promise<ProblemDefinitionFull | null> {
 ...
 */
export async function deleteProblemDefinition(id: number): Promise<boolean> {
  const [updated] = await db
    .update(problemDefinitions)
