...
): Promise<ConversationQualityDepartmentResult> {
  ...
  try {
    ...
    const result: ConversationQualityDepartmentResult = {
      ...
      technicalExecution: {
        ...
        technicalIssues: ensureArray<TechnicalIssue>(technicalExecution.technicalIssues),
      },
      callHandling: {
      ...
      behavioralAssessment: {
        strengths: ensureArray<string>(behavioralAssessment.strengths),
        weaknesses: ensureArray<string>(behavioralAssessment.weaknesses),
        flags: ensureArray<string>(behavioralAssessment.flags),
      },
      issueFlags: ensureArray<IssueFlag>(raw.issueFlags),
      transcriptAnnotations: ensureArray<TranscriptAnnotation>(raw.transcriptAnnotations),
