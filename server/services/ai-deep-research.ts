...
const DOMAIN_PROMPTS: Record<ResearchDomain, string> = {
 ...
 */
export async function executeResearch(req: ResearchRequest): Promise<ResearchResponse> {
 ...
 */
export async function executeCodeAssist(req: CodeAssistRequest): Promise<CodeAssistResponse> {
