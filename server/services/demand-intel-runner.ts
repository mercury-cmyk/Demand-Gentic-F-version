 ...
 */
async function researchCompanyCore(domain: string): Promise<any> {
 ...
 */
async function researchMarketPosition(domain: string): Promise<any> {
 ...
 */
async function researchCustomerIntelligence(domain: string): Promise<any> {
  try {
 ...
 */
async function researchNewsAndTrends(domain: string): Promise<any> {
  try {
 ...
 */
async function getContactInsights(accountId: string): Promise<any> {
  try {
 ...
 */
export async function checkBuyingSignals(domain: string): Promise<BuyingSignal[]> {
 ...
 */
export async function getRecommendedApproach(domain: string): Promise<RecommendedApproach> {
  const result = await runDemandIntelResearch({
    domain,
