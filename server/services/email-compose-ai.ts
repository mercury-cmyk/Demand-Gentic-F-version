...
The body should be clean HTML suitable for an email client. Use <p> tags for paragraphs and <br> for line breaks.
...
Use <p> and <br> tags. Preserve the original structure and intent.`;
