...
export interface ITelephonyProvider {
   ...
   */
  initialize(config: TelephonyProviderConfig): Promise<void>;
   ...
   */
  originateCall(options: CallOptions): Promise<CallResult>;
  
  /**
   * Answer an inbound call
   */
  answerCall(callControlId: string): Promise<CallResult>;
  
  /**
   * Hangup a call
   */
  hangupCall(options: HangupOptions): Promise<CallResult>;
  
  /**
   * Transfer a call
   */
  transferCall(options: TransferOptions): Promise<CallResult>;
  
  /**
   * Bridge two calls together
   */
  bridgeCalls(options: BridgeOptions): Promise<CallResult>;
  
  /**
   * Play audio on a call
   */
  playAudio(options: PlayAudioOptions): Promise<CallResult>;
  
  /**
   * Speak text on a call (TTS)
   */
  speak(options: SpeakOptions): Promise<CallResult>;
  
  /**
   * Gather DTMF digits
   */
  gatherDigits(options: GatherOptions): Promise<CallResult>;
  
  /**
   * Start media streaming (for AI integration)
   */
  startStream(options: StreamOptions): Promise<CallResult>;
  
  /**
   * Stop media streaming
   */
  stopStream(callControlId: string): Promise<CallResult>;
  
  /**
   * Get call status
   */
  getCallStatus(callControlId: string): Promise<CallStatus | null>;
