...
async function processLeadBackfill(): Promise {
...
async function processCallSessionBackfill(): Promise {
  const stats: Stats = { scanned: 0, updated: 0, skipped: 0, failed: 0 };
  let remaining = MAX_ROWS;
  let offset = 0;
...
async function propagateCanonicalUrlsToDependentEntities(): Promise> {
