...
async function fetchNumberByE164(phoneNumber: string): Promise {
...
async function enableCNAM(numberId: string, phoneNumber: string): Promise {
...
async function enableNoiseSuppression(numberId: string, phoneNumber: string): Promise {
...
async function addToNumberPool(num: TelnyxNumber): Promise {
  try {
