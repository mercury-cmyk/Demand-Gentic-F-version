...
export const operatorDescriptions: Record = {
...
export const accountFilterFields: Record = {
  // Text fields
  name: {
...
export const contactFilterFields: Record = {
  // Text fields
  fullName: {
...
export type FilterCondition = z.infer;
...
export type FilterGroup = z.infer;
...
export type SavedFilter = z.infer;

// =============================================================================
// LEAD FILTER FIELDS
// =============================================================================
export const leadFilterFields: Record = {
  // Lead Status & Quality
  qaStatus: {
    label: 'QA Status',
    type: 'enum',
...
// =============================================================================
export const campaignFilterFields: Record = {
...
// =============================================================================
export const segmentFilterFields: Record = {
  name: {
    label: 'Name',
    type: 'text',
...
// =============================================================================
export const suppressionFilterFields: Record = {
  type: {
    label: 'Type',
    type: 'enum',
...
// ORDER FILTER FIELDS
// =============================================================================
export const orderFilterFields: Record = {
  orderNumber: {
    label: 'Order Number',
    type: 'text',
...
export const filterFieldsByEntity: Record> = {
