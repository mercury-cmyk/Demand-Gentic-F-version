 ...
 */
export const UNIFIED_FIELD_CONFIGS: Record = {
  // ============================================
  // CONTACT FIELDS
  // ============================================
  firstName: {
 ...
 */
export const MODULE_FIELD_SETS: Record = {
  contacts: [
    // Contact fields
    "firstName",
    "lastName",
 ...
 */
export function getFieldsByCategory(category: EntityCategory): Record {
 ...
 */
export function getFieldsForModule(module: string): Record {
