...
const stats = await client.query(`
  SELECT
    ...
    COUNT(*) FILTER (WHERE full_transcript IS NULL OR LENGTH(full_transcript) = 20 AND (full_transcript IS NULL OR full_transcript LIKE '[SYSTEM:%')) as long_calls_no_real_transcript,
