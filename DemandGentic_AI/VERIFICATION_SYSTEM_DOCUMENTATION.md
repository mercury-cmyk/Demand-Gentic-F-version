...
{showFilters && (
        ...
        Contact Search
         setFilters({ ...filters, contactSearch: e.target.value })}
          data-testid="input-contact-search"
        />
      
      
        Company Search
         setFilters({ ...filters, companySearch: e.target.value })}
          data-testid="input-company-search"
        />
      
      
        Source Type
         setFilters({ ...filters, sourceType: value === "all" ? "" : value })}
        >
        ...
        Suppression Status
         setFilters({ ...filters, suppressionStatus: value === "all" ? "" : value })}
        >
...
{accountId && (
      ...
      Associated Contacts from {accountName}
      ...
      {associatedContacts.length > 0 ? (
          ...
          {associatedContacts.map((assocContact, index) => (
                  ...
                  {assocContact.verificationStatus}
