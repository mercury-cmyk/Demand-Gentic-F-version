...
async function findOrphanedFromDialerCallAttempts(campaignId?: string): Promise {
...
async function findOrphanedFromCallSessions(campaignId?: string): Promise {
...
async function createLeadFromOrphan(orphan: OrphanedRecord): Promise {
  try {
    ...
    const isShortDuration = callDuration ();
