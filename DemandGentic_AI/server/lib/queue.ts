 ...
 */
async function initializeRedisConnection(): Promise {
 ...
 */
async function initializeSubscriberConnection(): Promise {
...
let connectionInitPromise: Promise | null = null;
 ...
 */
async function ensureRedisInitialized(): Promise {
 ...
 */
export async function getRedisConnectionAsync(): Promise {
 ...
 */
export async function closeQueueConnections(): Promise {
  if (redisSubscriber) {
    try {
