...
export function getGcpConfig(): Readonly { return _config; }

// ---------------------------------------------------------------------------
// Change listeners — services register to be notified on account switch
// ---------------------------------------------------------------------------
type ConfigChangeListener = (config: Readonly) => void | Promise;
 ...
 */
export async function updateGcpConfig(newConfig: Partial): Promise {
