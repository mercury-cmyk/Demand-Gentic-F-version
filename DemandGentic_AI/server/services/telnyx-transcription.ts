 ...
 */
async function enableNoiseSuppression(callControlId: string): Promise {
  try {
    const response = await fetch(
 ...
 */
export async function disableCallTranscription(callControlId: string): Promise {
  if (!TELNYX_API_KEY) {
    return false;
  }
 ...
 */
export async function transcribeRecording(recordingUrl: string): Promise {
  if (!TELNYX_API_KEY) {
 ...
 */
async function transcribeViaOpenAiSdk(recordingUrl: string): Promise {
 ...
 */
async function transcribeViaLegacyApi(recordingUrl: string): Promise {
 ...
 */
export async function transcribeLeadCall(leadId: string): Promise {
 ...
 */
export async function transcribeCallAttempt(callAttemptId: string): Promise {
  try {
 ...
 */
export async function processPendingTranscriptions(): Promise {
  try {
