 ...
 */
export async function setDefaultOrganization(id: string): Promise {
...
export async function updateOrganizationIntelligence(
  ...
  if (intelligence.identity) {
    updates.identity = { ...(org.identity as Record), ...intelligence.identity };
  }
  if (intelligence.offerings) {
    updates.offerings = { ...(org.offerings as Record), ...intelligence.offerings };
  }
  if (intelligence.icp) {
    updates.icp = { ...(org.icp as Record), ...intelligence.icp };
  }
  if (intelligence.positioning) {
    updates.positioning = { ...(org.positioning as Record), ...intelligence.positioning };
  }
  if (intelligence.outreach) {
    updates.outreach = { ...(org.outreach as Record), ...intelligence.outreach };
  }
...
function buildCompiledOrgContext(org: CampaignOrganization): string {
  ...
  const identity = org.identity as Record || {};
  const offerings = org.offerings as Record || {};
  const icp = org.icp as Record || {};
  const positioning = org.positioning as Record || {};
  const outreach = org.outreach as Record || {};
