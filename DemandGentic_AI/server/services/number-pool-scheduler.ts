 ...
 */
async function activateAllNumbersOnStartup(): Promise {
  try {
 ...
 * Run a specific task
 */
async function runTask(name: string): Promise {
 ...
 */
export async function triggerTask(name: string): Promise {
  await runTask(name);
}
