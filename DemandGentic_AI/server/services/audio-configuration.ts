...
export const UNIFIED_AUDIO_CONFIG = {
  ...
  // Telnyx WebSocket  bidirectional supports: PCMU, PCMA, G722, OPUS, AMR-WB, L16
 ...
 *
 * Future-proofing: Once Telnyx WebSocket  supports G.722 or OPUS,
...
export function validateConfigurationConsistency(): { consistent: boolean; warnings: string[] } {
  ...
  if (UNIFIED_AUDIO_CONFIG.normalization.targetLevelTelnyx  0.99) {
