 ...
 */
export async function getUnifiedKnowledge(): Promise {
  try {
 ...
 */
export async function getKnowledgeVersion(version: number): Promise {
 ...
 */
export async function resetToDefaultKnowledge(userId: string | null): Promise {
