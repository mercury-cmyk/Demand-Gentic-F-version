 ...
 */
export async function loadCampaignQualificationContext(campaignId: string): Promise {
  try {
...
export function determineSmartDisposition(
  ...
  // HARD GATE: Very short calls (= 2 && analysis.hasRealConversation && analysis.userTurns >= 3 && callDurationSeconds >= 45;
