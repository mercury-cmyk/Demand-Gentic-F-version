...
export default class CloudWorkstationsManager extends EventEmitter {
  ...
  async createCluster(request: CreateClusterRequest): Promise {
    const client = await this.getClient();
  ...
  async listConfigs(clusterId: string): Promise {
    const client = await this.getClient();
  ...
  async createConfig(request: CreateConfigRequest): Promise {
    const client = await this.getClient();
  ...
  async deleteConfig(clusterId: string, configId: string): Promise {
    const client = await this.getClient();
  ...
  async listWorkstations(clusterId: string, configId: string): Promise {
    const client = await this.getClient();
  ...
  async listAllWorkstations(): Promise {
  ...
  async createWorkstation(request: CreateWorkstationRequest): Promise {
    const client = await this.getClient();
  ...
  async startWorkstation(clusterId: string, configId: string, workstationId: string): Promise {
    const client = await this.getClient();
  ...
  async stopWorkstation(clusterId: string, configId: string, workstationId: string): Promise {
    const client = await this.getClient();
  ...
  async deleteWorkstation(clusterId: string, configId: string, workstationId: string): Promise {
    const client = await this.getClient();
  ...
  async generateAccessToken(clusterId: string, configId: string, workstationId: string): Promise {
    const client = await this.getClient();
   ...
   */
  private async autoGrantWorkstationIAM(clusterId: string, configId: string, workstationId: string): Promise {
    const https = await import('https');
    const metadata = await import('http');

    // Get access token from metadata server
    const metaToken = await new Promise((resolve, reject) => {
      metadata.get(
    ...
    const saEmail = await new Promise((resolve, reject) => {
      metadata.get(
