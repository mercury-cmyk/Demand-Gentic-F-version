...
export interface IVoiceProvider extends EventEmitter {
   ...
   */
  configure(config: VoiceProviderConfig): Promise;
...
export abstract class BaseVoiceProvider extends EventEmitter implements IVoiceProvider {
  ...
  abstract configure(config: VoiceProviderConfig): Promise;
...
export const OPENAI_TO_GEMINI_VOICE_MAP: Record = {
  'alloy': 'Aoede',
  'echo': 'Charon',
  'fable': 'Fenrir',
  'nova': 'Kore',
...
export const GEMINI_TO_OPENAI_VOICE_MAP: Record = {
  // Primary mappings
  'Aoede': 'alloy',
  'Charon': 'echo',
  'Fenrir': 'fable',
