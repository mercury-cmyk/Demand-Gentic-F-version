...
describe('generateAdminEmailTemplateFromPromptSystem', () => {
  ...
  it('extracts takeaways and speakers from landing page html when present', async () => {
    ...
    const html = `
            ...
            Learn how enterprise teams turn webinars into qualified pipeline through better planning and follow-up.
            What you'll learn
            
              How to increase registration rates with better value framing
              How to improve attendance with smart reminder cadences
              How to drive post-event conversion with focused next steps
            
            Speakers
            
              Nina Patel, Director of Demand Gen
              Chris Wong, VP Marketing Operations
            
            March 22, 2026 at 2:00 PM ET
