 ...
 */
export async function mapTitle(rawTitle: string): Promise {
 ...
 */
export async function mapTitlesBatch(rawTitles: string[]): Promise {
 ...
 */
async function tryFuzzyMatch(normalizedTitle: string): Promise> {
 ...
 */
async function mapTitleWithAI(rawTitle: string): Promise {
  try {
 ...
 */
export async function getAdjacentRoles(roleId: number): Promise {
...
export class TitleMappingService implements ITitleMappingService {
  async mapTitle(rawTitle: string): Promise {
    return mapTitle(rawTitle);
  }

  async mapTitlesBatch(rawTitles: string[]): Promise {
    return mapTitlesBatch(rawTitles);
  }

  async getAdjacentRoles(roleId: number): Promise {
