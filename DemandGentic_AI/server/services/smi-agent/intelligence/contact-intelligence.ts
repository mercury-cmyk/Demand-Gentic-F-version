...
export async function getContactIntelligence(
  ...
  return {
    ...
    likelyPriorities: parseJsonArray(intel.likelyPriorities),
    communicationStyleHints: parseJsonObject(intel.communicationStyleHints) || getDefaultCommunicationStyle(),
    painPointSensitivity: parseJsonObject>(intel.painPointSensitivity) || {},
    ...
    engagementHistorySummary: parseJsonObject(intel.engagementHistorySummary) || getDefaultEngagementHistory(),
 ...
 */
export async function invalidateContactIntelligence(contactId: string): Promise {
  await db
 ...
 */
async function getEngagementHistory(contactId: string): Promise {
...
export class ContactIntelligenceService implements IContactIntelligenceService {
  ...
  async getContactIntelligence(contactId: string): Promise {
    return getContactIntelligence(contactId);
  }

  async invalidateContactIntelligence(contactId: string): Promise {
