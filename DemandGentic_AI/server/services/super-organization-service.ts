 ...
 */
export async function initializeSuperOrganization(): Promise {
 ...
 */
export async function getSuperOrganization(): Promise {
  const [org] = await db
    .select()
 ...
 */
export async function deleteClientOrganization(organizationId: string): Promise {
  // Verify it's a client organization
 ...
 */
export async function isSuperOrgOwner(userId: string): Promise {
  const superOrg = await getSuperOrganization();
 ...
 */
export async function canAccessSuperOrgSettings(userId: string): Promise {
 ...
 */
export async function getCredentialByKey(key: string): Promise {
  const superOrg = await getSuperOrganization();
 ...
 */
export async function getCredentialValue(key: string): Promise {
 ...
 */
export async function getCredentialsByCategory(category: string): Promise {
  const superOrg = await getSuperOrganization();
  if (!superOrg) return [];
 ...
 */
export async function getAllCredentials(): Promise & { maskedValue: string }>> {
  const superOrg = await getSuperOrganization();
  if (!superOrg) return [];
 ...
 */
export async function getClientOrganizations(): Promise {
  return db
    .select()
    .from(campaignOrganizations)
    .where(
 ...
 */
export async function getOrganizationMemberCount(organizationId: string): Promise {
  const [result] = await db
    .select({ count: count() })
    .from(organizationMembers)
    .where(eq(organizationMembers.organizationId, organizationId));
 ...
 */
export async function setupAdminAsSuperOrgOwner(adminUserId: string): Promise {
  const superOrg = await getSuperOrganization();
  if (!superOrg) {
