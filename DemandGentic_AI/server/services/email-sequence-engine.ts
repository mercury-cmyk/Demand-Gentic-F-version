 ...
 */
export async function processSequenceEnrollments(): Promise {
  try {
 ...
 */
async function sendSequenceEmail(enrollment: any, step: SequenceStep): Promise {
 ...
 */
async function createSequenceTask(enrollment: any, step: SequenceStep): Promise {
 ...
 * Pause enrollment
 */
export async function pauseEnrollment(enrollmentId: string): Promise {
  await db
    .update(sequenceEnrollments)
 ...
 * Resume enrollment
 */
export async function resumeEnrollment(enrollmentId: string): Promise {
  await db
    .update(sequenceEnrollments)
