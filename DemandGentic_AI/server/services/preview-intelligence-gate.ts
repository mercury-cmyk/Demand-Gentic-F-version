...
async function resolveCampaignOrganization(campaignId: string): Promise {
...
function hasStructuredIntelligenceSection(section: unknown): boolean {
  return !!section && typeof section === 'object' && Object.keys(section as Record).length > 0;
}
...
async function autoGenerateOrganizationIntelligence(campaignId: string): Promise {
  ...
  await db
    ...
    .set({
      identity: {
        ...((organization.identity as Record) || {}),
        ...mapped.identity,
      },
      offerings: {
        ...((organization.offerings as Record) || {}),
        ...mapped.offerings,
      },
      icp: {
        ...((organization.icp as Record) || {}),
        ...mapped.icp,
      },
      positioning: {
        ...((organization.positioning as Record) || {}),
        ...mapped.positioning,
      },
      outreach: {
        ...((organization.outreach as Record) || {}),
        ...mapped.outreach,
      },
