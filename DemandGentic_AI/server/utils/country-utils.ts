...
export const UK_COUNTRY_KEYS = new Set([
  'GB', 'UK', 'UNITED KINGDOM', 'UNITED KINGDOM UK',
  'GREAT BRITAIN', 'ENGLAND', 'SCOTLAND', 'WALES',
]);

export const US_COUNTRY_KEYS = new Set([
...
const MIDDLE_EAST_COUNTRY_KEYS = new Set([
...
const ENABLED_CALLING_REGIONS: Record = {
  // Australia / NZ
...
export const COUNTRY_DIAL_PREFIX: Record = {
