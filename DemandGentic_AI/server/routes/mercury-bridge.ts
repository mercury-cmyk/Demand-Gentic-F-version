...
3. Use inline CSS styles (email clients don't support  blocks well)
...
Return valid JSON with:
{
  ...
  "textTemplate": "Updated plain text"
    ...
    const result = await generateJSON(prompt, { temperature: 0.7, maxTokens: 4096 });
