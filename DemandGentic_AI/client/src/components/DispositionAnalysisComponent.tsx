  ...
  return (
      ...
      {/* Info Section */}
        ...
        ℹ️ How It Works
            ...
            Preview: Shows what changes would be made without
            modifying the database
          
          
            Apply: Makes the recommended changes permanently
            ...
            Export: Download results in CSV, JSON, or JSONL
            format
