  ...
  const readinessChecks = [
    {
      ...
      detail: selectedSender ? `${selectedSender.name} ` : "Choose who the campaign sends from.",
    },
    {
      ...
      {validationErrors.length > 0 && (
            ...
            {validationErrors.map((error) => (
                ...
                {error}
                    ...
                    Sender Route
                    Pick the identity this campaign sends from before drafting the message.
                ...
                />
                  ...
                  Campaign Story
                  The AI and the editor use this context as the operating frame for the message.
              ...
              {[
                ...
                { label: "Audience", value: audienceCount > 0 ? `${audienceCount.toLocaleString()} contacts` : "Audience selected" },
                  ...
                  Live Snapshot
                  This updates as the editor changes, so the wizard always reflects the current draft.
                  ...
                  Preview Text
                  {preheader || "No preview text yet"}
                
                
                  Sender
                  
                    {selectedSender ? `${selectedSender.name} ` : "No sender selected"}
                  ...
                  Readiness
                  Quick preflight before you move to scheduling.
