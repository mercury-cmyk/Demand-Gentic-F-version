...
export class AudioBridgeController {
   ...
   */
  private async handleOpenAIOutputTrack(track: MediaStreamTrack): Promise {
   ...
   */
  async switchToHumanMode(): Promise {
    if (this.mode === 'human') {
