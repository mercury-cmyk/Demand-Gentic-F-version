...
3. **Target list quality**: ${(conversations.length/result.rows.length*100).toFixed(1)}% connection rate is ${(conversations.length/result.rows.length*100)  {
