...
## 4. TeXML <Stream> Example
If using TeXML:
```xml
<Response>
  <Connect>
    <Stream url="wss://abcdef.ngrok-free.app" bidirectionalMode="rtp">
       <Parameter name="stream_codec" value="PCMU"/>
       <Parameter name="stream_bidirectional_codec" value="PCMU"/>
       <Parameter name="stream_bidirectional_sampling_rate" value="8000"/>
    </Stream>
  </Connect>
</Response>
```
